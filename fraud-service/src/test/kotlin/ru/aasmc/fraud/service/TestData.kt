...
val orders = listOf(
    ...
    Order("6", 2L, CREATED, UNDERPANTS, 10, 100.0), //Second should fail as rolling total by customer is over limit
    Order("7", 2L, CREATED, UNDERPANTS, 1, 5.0),  //Third should fail as rolling total by customer is still over limit
)
